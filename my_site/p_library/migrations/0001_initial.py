# Generated by Django 3.1.2 on 2020-10-21 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_img', models.ImageField(blank=True, null=True, upload_to='books_img', verbose_name='Book image')),
                ...
                ('publisher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='book_publisher', to='p_library.publisher', verbose_name='Publishing house')),
                ('reader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='book_reader', to='p_library.friend', verbose_name='Reader')),
            ],
        ),
    ]
